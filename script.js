...
function getProductCardHtml(product, index) {
  return `
    <div class="product-card">
      ...
      <div class="btns">
        <button type="button" data-index="${index}" data-action="remove">Remove</button>
        <button type="button" data-index="${index}" data-action="add-to-cart">Add to Cart</button>
      </div>
    </div>
  `;
}
...
function renderProducts() {
  ...
  const allProducts = productsData
    ...
    .join("");
  sectionElement.innerHTML = allProducts;
}
